...
export const COURSES: ICoursesListItem[] = [
    ...
    new CoursesListEntry(3, 'Video Three', new Date('December 17, 2017 03:24:00'),
      15,
      'Not a very interesting video but the topic is extremely important and you have to watch it, thanks God it is quite short.',
      false),
